...
3)  removes any false precision based on the upstream radiometric bit depth of
    the sensor
4)  adds metadata to the label data
...
```{r}
write_csv(LS57, paste0("data/labels/harmonized_LS57_labels_v", harmonize_version, ".csv"))
write_csv(LS89, paste0("data/labels/harmonized_LS89_labels_v", harmonize_version, ".csv"))
write_csv(S2, paste0("data/labels/harmonized_SEN2_labels_v", harmonize_version, ".csv"))
```
