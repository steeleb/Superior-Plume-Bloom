...
This leaves ~2% of the Landsat 5 labels and <5% of the Landsat 7 labels as
inconsistent and shouldn't be included in the test/train set. The number of LS7 
...
Also, since we're not going to classify saturated pixels, we'll drop those 
too. Let's do a quick sanity check to make sure that we've dropped values that 
are inconsistent between pulls:
