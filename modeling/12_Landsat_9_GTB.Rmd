...
# import the python functions used throughout this and other scripts
import imp
...
When your browser states 'Google Earth Engine authentication successful!', the
...
aoi_area = aoi_ee.map(gf.calc_area).aggregate_sum('area_ha')
...
aoi_no_sc_area = aoi_no_sc_ee.map(gf.calc_area).aggregate_sum('area_ha')
...
aoi_sc_area = aoi_sc_ee.map(gf.calc_area).aggregate_sum('area_ha')
