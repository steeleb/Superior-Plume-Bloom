...
```{python}
training_sen = ee.FeatureCollection("projects/ee-ross-superior/assets/train-test/training_sen")
testing_sen = ee.FeatureCollection("projects/ee-ross-superior/assets/train-test/testing_sen")
```
