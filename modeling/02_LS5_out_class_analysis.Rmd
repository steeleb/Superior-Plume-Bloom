...
This leaves `r round(nrow(LS5_inconsistent)/nrow(LS5)*100, 1)`% of the Landsat 5
...
Ooo, yeah, there are some clouds there and some lower quality images. We should
probably drop any labels that have a cirrus QA flag that aren't cloud labels.
...
QA_RADSAT for all labels (including clouds) are set to zero.
